...
const Group1 = ({ colors: propColors }) => {
  const defaultColors = { fill1: "#F0A47D", fill2: "#634653", fill3: "#E6294F", fill4: "#F8EAD3", fill5: "#BA2140", fill6: "#47323B", fill7: "#FFC19E" };

  const colors = { ...defaultColors, ...propColors };
  const { fill1, fill2, fill3, fill4, fill5, fill6, fill7 } = colors;
    ...
    <View style={{ flex: 1, width: '100%', height: '100%' }}>
      ...
      >
        ...
        <Path
          ...
          fill={fill3}
        />
        <Path d="M200 336s-16 56 48 56 48-56 48-56h-96z" fill={fill4} />
        <Path
...
Group1.propTypes = {
  colors: PropTypes.shape({
    ...
    fill6: PropTypes.string,
    fill7: PropTypes.string,
  }),
};
