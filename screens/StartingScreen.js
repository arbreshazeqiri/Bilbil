        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            <View style={styles.base} >
                ...
                <View style={styles.buttons}>
                    <CustomButton title="GET STARTED" color="white" bgColor="#FFC700" borderColor={'#DBAE0D'}/>
                    <CustomButton title="I ALREADY HAVE AN ACCOUNT" color="#FFC700" bgColor="white" borderColor={'#E5E5E5'}/>
                </View>
            </View>
        </SafeAreaView>
    )
